...
static void print_help(const char* prog)
{
    std::cout
        ...
        << "  " << prog << " --cli [a.yaml ... n.yaml]     Run in CLI mode (only depends on yaml-cpp)\n"
        << "  " << prog << " serve [options] <files>       Host an SSH quiz server\n"
        << "  " << prog << " -h, --help                    Show this help menu\n"
        << "\n"
        << "CLI MODE\n"
        << "  CLI Fallback in case you enjoy the CLI experience, or you dont like TUI!\n"
        << "\n"
        << "  " << prog << " --cli quiz.yaml\n"
        << "  " << prog << " --cli [a.yaml ... n.yaml]\n"
        << "\n"
        << "LOCAL MODE\n"
